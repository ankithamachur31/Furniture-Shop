...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkQty() {
            ...
            if (qty > 50) {
                alert("Please contact the sales team when ordering more than 50!")
                return false;
            }
            ...
            if ($fetchedRow == null) {
                echo "  <div id='infoNotFoundThickLine'></div>
                            <div id='prodNotFoundDiv'> 
                                ...
                                <h5>Can't find what you are looking for? Contact our sales assistants.</h5>
                ...
                if (isset($_POST["btnAddToBasket"])) // IF ADD TO BASKET BUTTON CLICKED
                {
                    ...
                    // Add the following code to insert the product into the 'cart' table
                    $insertQuery = "INSERT INTO cart (prodId, prodName,price) VALUES ('$id', '$name', '$price')";
                    $insertResult = mysqli_query($connection, $insertQuery);

                    if ($insertResult) {
                        echo "Product added to the cart successfully!";
                    } else {
                        echo "Error adding product to the cart: " . mysqli_error($connection);
                    }
